...
<div id="theme-page" <?php echo get_schema_markup('main'); ?>>
 ...
 ?>
							...
							<div class="blog-single-meta">
								<div class="mk-blog-author"><?php _e('От', 'mk_framework'); ?> <?php the_author_posts_link(); ?></div>
									<time class="mk-post-date" datetime="<?php the_date() ?>">
										<?php _e('Опубликовано', 'mk_framework'); ?> <a href="<?php echo get_month_link( get_the_time( "Y" ), get_the_time( "m" ) ); ?>"><?php echo get_the_date(); ?></a>
									</time>
									<div class="mk-post-cat"> <?php _e('В', 'mk_framework'); ?> <?php the_category( ', ' ) ?></div>
							</div>
							<?php endif; ?>
							...
							<div class="single-social-section">
								...
								<div class="blog-share-container">
									...
									<ul class="single-share-box mk-box-to-trigger">
										<li><a class="facebook-share" data-title="<?php the_title(); ?>" data-url="<?php echo get_permalink(); ?>" href="https://www.facebook.com/tvoya.peremoga3/"><i class="mk-jupiter-icon-simple-facebook"></i></a></li>
										<li><a class="vk-share" data-title="<?php the_title(); ?>" data-url="<?php echo get_permalink(); ?>" href="https://vk.com/club48802465"><i class="mk-jupiter-icon-simple-vk"></i></a></li>
										<li><a class="instagram-share" data-title="<?php the_title(); ?>" data-url="<?php echo get_permalink(); ?>" href="https://instagram.com/tvoya_peremoga/"><i class="mk-jupiter-icon-simple-instagram"></i></a></li>
									</ul>
								</div>
								<?php endif; ?>
								<a class="mk-blog-print" onClick="window.print()" href="#" title="<?php _e('Печать', 'mk_framework'); ?>"><i class="mk-moon-print-3"></i></a>
