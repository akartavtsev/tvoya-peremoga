...
?>
	<div class="mk-quick-contact-wrapper">
		<a href="#" class="mk-quick-contact-link"><span>Обратный звонок</span></a>
		<div id="mk-quick-contact">
			<div class="mk-quick-contact-title"><?php
				_e('Ваши контакты', 'mk_framework');?></div>
			<p><?php
				_e('Закажите обратный звонок прямо сейчас!', 'mk_framework');?></p>
			<form class="mk-contact-form" method="post" novalidate="novalidate">
				...
				<input type="tel" pattern="[0-9]{10,11}" placeholder="<?php
				_e('Номер телефона*', 'mk_framework'); ?>" required="required" id="contact_phone" name="contact_phone" class="text-input" tabindex="<?php
				echo $tabindex_2; ?>">
