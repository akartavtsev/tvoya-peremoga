...
$theme_options_general = array(
	...
	array(
		...
		"desc" => __("If you want to use typekit in your site simply enter The Type Kit ID you get from Typekit site. <a target='_blank' href='http://help.typekit.com/customer/portal/articles/6840-using-typekit-with-wordpress-com'>Читать Далее</a>", "mk_framework"),
		"id" => "typekit_id",
		"default" => "",
		"type" => "text",
	),
