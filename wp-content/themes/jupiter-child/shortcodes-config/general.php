...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            ...
            "description" => __("This option sets whether the background image is fixed or scrolls with the rest of the page. <a href='http://www.w3schools.com/CSSref/pr_background-attachment.asp'>Читать Далее</a>", "mk_framework") ,
            "dependency" => array(
...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            "type" => "textfield",
            "heading" => __("Читать Текст Далее", "mk_framework") ,
        ...
        array(
            "type" => "textfield",
            "heading" => __("Читать URL Далее", "mk_framework") ,
