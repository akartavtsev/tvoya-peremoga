...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            ...
            "description" => __("The background-attachment property sets whether a background image is fixed or scrolls with the rest of the page. <a href='http://www.w3schools.com/CSSref/pr_background-attachment.asp'>Читать Далее</a>", "mk_framework")
        ),
        array(
            "type" => "dropdown",
