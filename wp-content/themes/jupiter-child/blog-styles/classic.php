    ...
    $output .= '<div class="mk-blog-meta">';
        ...
        if ($disable_comments_share != 'false') {
            ...
            if ($mk_options['single_blog_social'] == 'true'):
                ...
                $output .= '<li><a class="vk-share" data-title="' . get_the_title() . '" data-url="' . get_permalink() . '" href="https://vk.com/club48802465"><i class="mk-jupiter-icon-simple-vk"></i></a></li>';
                
                $output .= '<li><a class="instagram-share" data-desc="' . strip_tags(get_the_excerpt()) . '" data-title="' . get_the_title() . '" data-url="' . get_permalink() . '" href="https://instagram.com/tvoya_peremoga/"><i class="mk-jupiter-icon-simple-instagram"></i></a></li>';
                $output .= '</ul>';
                $output .= '</span>';
            endif;
        }
        $output .= '<a class="mk-readmore" href="' . get_permalink() . '"><i class="mk-moon-arrow-right-2"></i>' . __('ЧИТАТЬ ДАЛЕЕ', 'mk_framework') . '</a>';
        $output .= '<div class="clearboth"></div>';
