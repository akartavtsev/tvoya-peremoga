...
function blog_thumbnail_style($atts, $current)
{
    ...
    */
    ...
    $output .= '        <div class="mk-teader-button">'.
                            do_shortcode( '[mk_button dimension="outline" corner_style="pointed" outline_skin="custom" outline_active_color="#000000" outline_hover_color="#fff" margin_bottom="0" size="medium" align="left" url="'.get_permalink().'"]'.__('ЧИТАТЬ ДАЛЕЕ', 'mk_framework').'[/mk_button]' ).'
                            </div>';
    $output .= '        </div>';
    $output .= '    </div>';
