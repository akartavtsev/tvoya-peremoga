...
$output .= '<div class="mk-news-tab mobile-'.$responsive.' '.$el_class.'">';
...
foreach ( $cat_terms as $cat_term ) {
	...
	if ( $i == 1 ) {
		...
		$output .='<a class="new-tab-readmore" href="'.get_permalink().'">'.__( 'Читать Далее', 'mk_framework' ).'<i class="mk-icon-caret-right"></i></a>';
		$output .= '</div>';
