...
$output .= '<a class="mk-loadmore-button '.$paginaton_style_class.'-btn" style="display:none;" href="#"><i class="mk-moon-loop-4"></i><i class="mk-moon-arrow-down-4"></i>' . __('Загрузить Далее', 'mk_framework') . '</a>';
if ($pagination == 'true') {
     ob_start();
