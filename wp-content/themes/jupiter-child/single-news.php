		...
		<div class="theme-page-wrapper <?php echo $page_layout; ?>-layout vc_row-fluid mk-grid <?php echo $padding; ?>">
			<div class="theme-content <?php echo $padding; ?>">
				...
				<?php if($mk_options['news_page'] != '') : ?>
					<a class="back-news-page" href="<?php echo get_permalink($mk_options['news_page']); ?>"><i class="mk-icon-double-angle-left"></i><?php _e('Вернуться к новостям', 'mk_framework'); ?></a>
				<?php endif; ?>

					<ul class="news-single-social">
						<li><a onClick="window.print()" href="#"><?php _e('Печать', 'mk_framework'); ?></a></li>
				...
				<div class="mk-back-top">
					<a href="#" class="mk-back-top-link"><i class="mk-icon-arrow-up"></i><?php _e('Наверх', 'mk_framework'); ?></a>
				</div>
