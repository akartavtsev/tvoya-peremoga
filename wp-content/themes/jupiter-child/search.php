		...
		<div class="theme-page-wrapper <?php echo $mk_options['search_page_layout'] ?>-layout  mk-grid vc_row-fluid row-fluid">
			<div class="theme-content">
				<section class="mk-search-loop">
					...
					<section class="widget widget_search"><p><?php _e('Недовольны результатами поиска? Введите другое ключевое слово ', 'mk_framework'); ?></p>
					<form class="mk-searchform" method="get" id="searchform" action="<?php echo home_url(); ?>">
					<input type="text" class="text-input" placeholder="<?php _e('Поиск по сайту', 'mk_framework'); ?>" value="" name="s" id="s" />
						...
						<article class="search-result-item">
							...
							<div class="search-loop-meta">
								...
								<time datetime="<?php the_time( 'F, j' ); ?>">
									<?php _e('Опубликовано', 'mk_framework'); ?> <a href="<?php echo get_month_link( get_the_time( "Y" ), get_the_time( "m" ) ); ?>"><?php the_time( 'M. t, h:i A' ); ?></a>
								</time>
								<?php endif; ?>
								<?php if($post_type == 'post') { ?>
								<span class="mk-search-cats"><?php _e('В', 'mk_framework'); ?> <?php echo get_the_category_list( ', ' ); ?></span>
